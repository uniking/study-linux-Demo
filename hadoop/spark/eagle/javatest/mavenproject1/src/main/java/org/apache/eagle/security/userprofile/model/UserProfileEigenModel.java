...
public class UserProfileEigenModel implements Serializable
{
   private final Long m_version;
	...
	private final RealMatrix m_uMatrix;
	private final RealMatrix m_diagonalMatrix;
	private final int m_dimension;
	private final RealVector m_minVector;
	private final RealVector m_maxVector;
	private final RealVector[] m_principalComponents;
	private final RealVector m_maximumL2Norm;
	private final RealVector m_minimumL2Norm;
        private final UserCommandStatistics[] m_statistics;

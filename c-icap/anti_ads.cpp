...
CI_DECLARE_MOD_DATA ci_service_module_t service = {
     "anti_ads",                         /* mod_name, The module name */
     "anti all ads",            /* mod_short_descr,  Module short description */
...
void *echo_init_request_data(ci_request_t * req)
{
    ...
    echo_data = (struct echo_req_data *)malloc(sizeof(struct echo_req_data));
    if (!echo_data) {
                               ...
                               ci_request_t * req)
{
     ...
     struct echo_req_data *echo_data = (struct echo_req_data *)ci_service_data(req);
